...
- Inspection, IMEI status, activation-lock removal, data erasure and a sale price above zero gate `Ready for sale`. Every checklist answer must be Pass or N/A.
